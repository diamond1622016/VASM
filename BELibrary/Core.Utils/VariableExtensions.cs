...
namespace BELibrary.Core.Utils
{
    ...
    {
        public const string LangCode = "scientis_lang_code";
        public const string Admin = "scientis_admin_cookies";
        public const string Client = "scientis_client_cookies";
    }
    ...
    public static class VariableExtensions
    {
        ...
        public static string DefautlPassword = "admin";
    }
