...
using ScientistVA.Areas.Admin.Models;
...
namespace ScientistVA.Areas.Admin.Controllers
{
    public class LoginController : Controller
    {
        ...
        public ActionResult Index(string returnUrl = "")
        {
            ...
            {
                return RedirectToAction("Index", "Scientist");
            }
            ...
            using (var workScope = new UnitOfWork(new ScientistDbContext()))
            {
                ...
                if (account != null)
                {
                    if (HttpContext.Request.Url != null)
                    {
                        ...
                        return Json(new { status = true, mess = "Login successful!" });
                    }
                    else
                    {
                        return Json(new { status = false, mess = "login failed!" });
                    }
                }
                else
                {
